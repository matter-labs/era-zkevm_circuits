...
def find_short_vectors(q: int, lambd: int, verbose: bool = False) -> tuple[GF, GF, GF, GF]:
    ...
    sl, tl, rl = trace[l]
    sl1, tl1, rl1 = trace[l+_sage_const_1 ]
    sl2, tl2, rl2 = trace[l+_sage_const_2 ]

    a1, b1 = rl1, -tl1
    if rl**_sage_const_2  + tl**_sage_const_2  <= rl2**_sage_const_2  + tl2**_sage_const_2 :
        a2, b2 = rl, -tl
    else:
        a2, b2 = rl2, -tl2
...
def _extended_euclidean_alg_trace(a: GF, b: GF, verbose: bool = False) -> list[tuple[GF, GF, GF]]:
    ...
    u, v = a, b
    x1, y1 = _sage_const_1 , _sage_const_0 
    x2, y2 = _sage_const_0 , _sage_const_1 
    r = a
...
# http://tomlr.free.fr/Math%E9matiques/Math%20Complete/Cryptography/Guide%20to%20Elliptic%20Curve%20Cryptography%20-%20D.%20Hankerson,%20A.%20Menezes,%20S.%20Vanstone.pdf
q = _sage_const_1461501637330902918203687013445034429194588307251 
...
assert a1 == _sage_const_788919430192407951782190 , 'a1 is incorrect'
assert b1 == -_sage_const_602889891024722752429129 , 'b1 is incorrect'
assert a2 == _sage_const_602889891024722752429129 , 'a2 is incorrect'
assert b2 == _sage_const_1391809321217130704211319 , 'b2 is incorrect'
